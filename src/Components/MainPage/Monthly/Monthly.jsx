...
//   const [showMontBalance, getShowMontBalance] = useState("");
  ...
  useEffect(() => {
    Axios.get("https://my-financial-assistant.herokuapp.com/monthly").then((response) => {
      getMonthly(response.data);
    });
  }, []);

//   useEffect(() => {
//     Axios.get("https://my-financial-assistant.herokuapp.com/balance/month").then((response) => {
...
//   }, []);
  ...
  useEffect(() => {
    Axios.get("https://my-financial-assistant.herokuapp.com/incomeSum/month").then((response) => {
  ...
  useEffect(() => {
    Axios.get("https://my-financial-assistant.herokuapp.com/outcomeSum/month").then((response) => {
